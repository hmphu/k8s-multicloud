...
variable "oci_node_pool_node_source_type" {
  description = "OCI Kubernetes node pool source type (allowed values: `'OCISERVICE', 'UNKNOWN_ENUM_VALUE'`)"
  type        = string
  default     = "UNKNOWN_ENUM_VALUE"
}
